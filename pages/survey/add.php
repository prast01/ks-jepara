                    ...
                    <div class="card card-shadow mb-4">
                        <div class="card-body">
                            ...
                            <form id="default">
                                ...
                                <input type="hidden" name="puskesmas" id="puskesmas" value="<?php echo $id_puskesmas; ?>">
                                <input type="hidden" name="page" value="simpan-survey-kk">
                                <fieldset title="Step 1" class="step" id="default-step-0">
                                    <legend> </legend>
                                    <h2 class="mb-3">Data Rumah Tangga</h2>

                                    
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            <input type="hidden" id="by" value="nik">
                                            <div class="input-group mb-3 row">
                                                <input type="text" maxlength="16" class="form-control" name="no_kk" id="no_kk" placeholder="Masukkan Nomor" aria-label="Masukkan Nomor" aria-describedby="basic-addon2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control date-picker-input" name="tgl_survei" value="<?php echo $date; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group mb-3 row">
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="jml_art" id="jml_art">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control" id="option_s4" name="kelurahan">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $d['id_kelurahan']; ?>">
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="no_urut_rt" id="no_urut_rt">
                                                </div>
                                                <label class="col-sm-2 col-form-label col-form-label-sm">No. Urut Keluarga</label>
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="no_urut_kel" id="no_urut_kel">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <input type="hidden" name="art_dewasa" id="art_dewasa">
                                <input type="hidden" name="art_10_54" id="art_10_54">
                                <input type="hidden" name="art_12_59" id="art_12_59">
                                <input type="hidden" name="art_0_11" id="art_0_11">
                                <input type="hidden" name="art_wawancara" id="art_wawancara" value="0">
